...
// Creamos el array de personas
    pArrayPersona = malloc(sizeof(struct persona));//PIDE MEMORIA PARA UNA PERSONA
    ...
    {
        printf("\nIngrese nombre: ");
        scanf("%s",(pArrayPersona+logitudPersonas-1)->nombre);//PARRAY ES UN PUNTERO
        printf("\nIngrese edad: ");
