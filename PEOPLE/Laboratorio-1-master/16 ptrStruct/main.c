...
int main()
{
    ...
    printf("\nNOMBRE: ");
    setbuf(stdin, NULL);
    scanf("%[^\n]", &per.nombre);   //gramatica, aceptar todo menos el contra "barra ene" \n
    ...
    printf("\nNOMBRE: ");
    setbuf(stdin, NULL);                //para cualquier sis.OP
    scanf("%[^\n]", ptrPer->nombre);

    printf("FECHA NACIMIENTO\n");

    printf("\nDIA: ");
    scanf("%d", &ptrPer->fechaNac.dia); //la flecha es solamente al puntero al campo
